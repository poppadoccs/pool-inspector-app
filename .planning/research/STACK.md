...
**Domain:** iPad-first field service forms app (PWA) with photo capture, AI form generation, email submission
...
```bash
# Core framework
npx create-next-app@latest pool-forms --typescript --tailwind --eslint --app --src-dir
...
# Supporting
npm install sonner lucide-react date-fns uuid
...
**If offline mode becomes required later:**
...
**If photo volume is very high (20+ photos per job):**
...
**If multiple form templates are needed later:**
...
---
*Stack research for: iPad-first field service forms PWA*
*Researched: 2026-03-25*
